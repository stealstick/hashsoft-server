    ...
    def handle(self, *args, **options):
        ...
        for charger_data in chargers_json['chargerList']:
            try:
                ...
                if charger_data['cid']   == "11" or charger_data['cid']   == 11:
                    charger_data['cid'] = 'BG'
                elif charger_data['cid']   == "12" or charger_data['cid']   == 12:
                    charger_data['cid'] = 'JE'
                elif charger_data['cid']   == "13" or charger_data['cid']   == 13:
                    charger_data['cid'] = 'KP'
                elif charger_data['cid']   == "14" or charger_data['cid']   == 14:
                    charger_data['cid'] = 'HE'
                elif charger_data['cid']   == "15" or charger_data['cid']   == 15:
                    charger_data['cid'] = 'PI'
                elif charger_data['cid']   == "16" or charger_data['cid']   == 16:
                    charger_data['cid'] = 'SE'
                elif  charger_data['cid']   == "17" or charger_data['cid']   == 17:
                    charger_data['cid'] = 'GI'
                elif  charger_data['cid']   == "18" or charger_data['cid']   == 18:
                    charger_data['cid'] = 'HD'
                elif  charger_data['cid']   == "19" or charger_data['cid']   == 19:
                    charger_data['cid'] = 'JD'
                elif  charger_data['cid']   == "20" or charger_data['cid']   == 20:
                    charger_data['cid'] = 'DG'
                elif  charger_data['cid']   == "22" or charger_data['cid']   == 22:
                    charger_data['cid'] = 'SS'
                elif  charger_data['cid']   == "23" or charger_data['cid']   == 23:
                    charger_data['cid'] = 'ST'
                elif  charger_data['cid']   == "24" or charger_data['cid']   == 24:
                    charger_data['cid'] = 'GN'
                elif  charger_data['cid']   == "25" or charger_data['cid']   == 25:
                    charger_data['cid'] = 'KT'
                elif  charger_data['cid']   == "26" or charger_data['cid']   == 26:
                    charger_data['cid'] = 'EV'
                elif  charger_data['cid']   == "27" or charger_data['cid']   == 27:
                    charger_data['cid'] = 'WR1'
                elif  charger_data['cid']   == "28" or charger_data['cid']   == 28:
                    charger_data['cid'] = 'WR2'
                elif  charger_data['cid']   == "29" or charger_data['cid']   == 29:
                    charger_data['cid'] = 'WR3'
                elif  charger_data['cid']   == "30" or charger_data['cid']   == 30:
